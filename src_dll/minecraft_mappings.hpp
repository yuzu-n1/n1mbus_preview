...
namespace Mappings {
    ...
    // GuiInventory
    inline const char* GuiInventory_Class = "net/minecraft/client/gui/inventory/GuiInventory";
    inline const char* GuiInventory_drawEntityOnScreen_Name = "func_147046_a";
    inline const char* GuiInventory_drawEntityOnScreen_Sig = "(IIIFFLnet/minecraft/entity/EntityLivingBase;)V";
    ...
    // PlayerControllerMP
    inline const char* PlayerControllerMP_curBlockDamageMP_Name = "field_78770_f";
    inline const char* PlayerControllerMP_curBlockDamageMP_Sig = "F";
    inline const char* PlayerControllerMP_getBlockReachDistance_Name = "func_78757_d";
    inline const char* PlayerControllerMP_getBlockReachDistance_Sig = "()F";
    ...
    inline const char* Entity_getDisplayName_Name = "func_145748_c_";
    inline const char* Entity_getDisplayName_Sig = "()Lnet/minecraft/util/IChatComponent;";
    inline const char* Entity_isOnSameTeam_Name = "func_142014_c";
    inline const char* Entity_isOnSameTeam_Sig = "(Lnet/minecraft/entity/Entity;)Z";
    
    inline const char* IChatComponent_Class = "net/minecraft/util/IChatComponent";
    inline const char* IChatComponent_getFormattedText_Name = "func_150254_d";
    inline const char* IChatComponent_getFormattedText_Sig = "()Ljava/lang/String;";
    ...
    inline const char* World_getBlockState_Name = "func_180495_p";
    inline const char* World_getBlockState_Sig = "(Lnet/minecraft/util/BlockPos;)Lnet/minecraft/block/state/IBlockState;";
    ...
    // MovingObjectPosition
    inline const char* MovingObjectPosition_blockPos_Name = "field_178783_e";
    inline const char* MovingObjectPosition_blockPos_Sig = "Lnet/minecraft/util/BlockPos;";

    // BlockState & Block
    inline const char* IBlockState_getBlock_Name = "func_177230_c";
    inline const char* IBlockState_getBlock_Sig = "()Lnet/minecraft/block/Block;";
    inline const char* Block_getIdFromBlock_Name = "func_149682_b";
    inline const char* Block_getIdFromBlock_Sig = "(Lnet/minecraft/block/Block;)I";
}
