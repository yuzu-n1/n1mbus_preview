...
namespace MC_Register {
    ...
    inline void all() {
        ...
        MC::registerField("EntityLivingBase.renderYawOffset",
            {LIVING, "pr"}, "F",
            {"field_70761_aq", "renderYawOffset"});

        MC::registerField("EntityLivingBase.rotationYawHead",
            {LIVING, "pr"}, "F",
        ...
        //  Networking & Packets
        // ════════════════════════════════════════════════════════════════════
        MC::registerMethod("NetHandlerPlayClient.addToSendQueue",
            {"net/minecraft/client/network/NetHandlerPlayClient", "bcy"},
            "(Lnet/minecraft/network/Packet;)V",
            {"func_147297_a", "addToSendQueue", "a"});

        MC::registerField("C0BPacketEntityAction.Action.START_SNEAKING",
            {"net/minecraft/network/play/client/C0BPacketEntityAction$Action", "ip$a"},
            "Lnet/minecraft/network/play/client/C0BPacketEntityAction$Action;",
            {"START_SNEAKING"});

        MC::registerField("C0BPacketEntityAction.Action.STOP_SNEAKING",
            {"net/minecraft/network/play/client/C0BPacketEntityAction$Action", "ip$a"},
            "Lnet/minecraft/network/play/client/C0BPacketEntityAction$Action;",
            {"STOP_SNEAKING"});

        MC::registerMethod("C0BPacketEntityAction.<init>",
            {"net/minecraft/network/play/client/C0BPacketEntityAction", "ip"},
        ...
        MC::registerField("World.loadedTileEntityList",
            {WORLD_BASE, "adm"},
            "Ljava/util/List;",
        ...
        // ════════════════════════════════════════════════════════════════════
        //  GuiInventory (PlayerModel rendering)
        // ════════════════════════════════════════════════════════════════════
        MC::registerMethod("GuiInventory.drawEntityOnScreen",
            {"net/minecraft/client/gui/inventory/GuiInventory", "bfl"},
            ("(IIIFF" + std::string("L") + LIVING + ";)V").c_str(),
            {"func_147046_a", "drawEntityOnScreen", "a"}, true);
